...
This is the same bot, but now for OKX, please check out the original Sunflow Cryptobot (made for Bybit) to get more information. Sunflow is tested on Python version 12.7.
